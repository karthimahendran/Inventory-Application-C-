...
namespace Truck_inventory
{
    public partial class customer : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Enter the customer name", "Data Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtSuppName.Focus();
                return;
            }
            ...
            int rowCount = ds.Tables["customer"].Rows.Count;
            for (int i = 0; i < rowCount; i++)
            {
                string lName = ds.Tables["customer"].Rows[i][0].ToString();

                if (lName == txtSuppName.Text.Trim())
                {
                    MessageBox.Show("The customer with this name, already exists in our record" +
                    Environment.NewLine + "Please enter different customer name", "Data Insert Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    txtSuppName.Focus();
                    return;
                }
            }
            ...
            DataTable MyTable = ds.Tables["customer"];
            ...
            DialogResult res = MessageBox.Show("The new customer details are added successfully" +
                Environment.NewLine + "Do you want to add more customer?"
                , "Add customer Success", MessageBoxButtons.YesNo);
